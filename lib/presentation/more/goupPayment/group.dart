                                ...
                                return Container(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Text("Description",style: TextStyle(fontSize: myApplication.widthClc(20, context),fontWeight: FontWeight.w700),),
                                      SizedBox(height: myApplication.hightClc(20, context),),
                                      Text(groupPayment.group[mainIndex]["description"],style: TextStyle(fontSize: myApplication.widthClc(20, context),fontWeight: FontWeight.w700),),
                                    ],
                                  ),
                                );
                              });
