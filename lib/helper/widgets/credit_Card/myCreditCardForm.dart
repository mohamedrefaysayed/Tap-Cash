...
MaskedTextController mycardNumberController =
MaskedTextController(mask: '0000 0000 0000 0000');
  TextEditingController myexpiryDateController =
...
class _myCreditCardFormState extends State<myCreditCardForm> {
  ...
  void initState() {
    ...
    mycardNumberController.text = widget.cardNumber;
    myexpiryDateController.text = widget.expiryDate;
              ...
              child: Container(
                ...
                child: TextFormField(
                  ...
                  onChanged: (String value) {
                    setState(() {
                      cardNumber = mycardNumberController.text;
                  ...
                  child: Expanded(
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        controller: myexpiryDateController,
                        onChanged: (String value) {
